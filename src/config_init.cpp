...
static void add_chanserv_options(po::options_description &opts)
{
	...
	opts.add_options()
		...
		("chanserv.defaults.join", mantra::value<bool>()->default_value(false), "")
		...
		("chanserv.lock.join", mantra::value<bool>()->default_value(false), "")
		...
		("chanserv.levels.akick", mantra::value<int>()->default_value(20), "")
